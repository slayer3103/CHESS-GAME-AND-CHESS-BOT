...
# Topbar (button placeholder)
def draw_topbar():
    pygame.draw.rect(win, (200, 200, 200), (0, 0, WIDTH, TOPBAR_HEIGHT))
    font = pygame.font.SysFont("Arial", 20)
    win.blit(font.render("Chess Game", True, (0, 0, 0)), (WIDTH // 2 - 60, 20))
...
def draw_pieces(board, drag_info):
    for square in chess.SQUARES:
        ...
        if piece:
            ...
            win.blit(images[key.upper()], (LEFTBAR_WIDTH + col * SQUARE_SIZE, TOPBAR_HEIGHT + row * SQUARE_SIZE))
...
def main():
    ...
    white_time, black_time = 300, 300  # 5 minutes each
